   ...
   return  (
    <header className={searchOpen ? style.headerStandart : style.headerSearch} >
            ...
            <div className={style.menuBtnBox}>
                <span className={searchOpen ? style.searchBtn : style.searchBtnClose} onClick={() => {setSearchOpen(!searchOpen)}}>{searchOpen ? searchBtn : closeSearchBtn}</span>
                <span className={searchOpen ? style.menuBtn : style.menuBtnClose} onClick={() => {setMenuOpen(!menuOpen)}} >{menuOpen ? openMenuBtn : closeMenuBtn}</span>
            </div>
